...
export default function RoleSelection() {
  ...
  const roles = [
    ...
    },
    {
      ...
      icon: MessageSquare,
      description:
        "Manage support tickets, customer queries, and AI-assisted responses",
      features: [
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        ...
        <div className="mt-16 p-6 bg-slate-50 rounded-xl border border-slate-200">
          ...
          <p className="text-slate-700 text-sm mb-4">
            ...
            automation platform. Each role has a unique dashboard with
            appropriate features and permissions.
          </p>
