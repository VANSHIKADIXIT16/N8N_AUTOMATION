      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={() => auth.logout()} className="p-2 hover:bg-slate-100 rounded-lg">
        ...
        <main className="flex-1 p-4 sm:p-8">
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-slate-600 text-sm mb-4">
                      You're making excellent progress! Complete all steps to
                      get fully onboarded.
                    </p>
                  </div>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      },
                      {
                        ...
                        description:
                          "Receive laptop, access cards, and other equipment",
                        completed: true,
                      },
                      {
                        title: "Training Materials",
                        description:
                          "Review company policies and training documents",
                        completed: true,
                      },
                      {
                ...
                <div className="bg-slate-50 px-6 py-4 border-b border-slate-200 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Standard onboarding attributes collected during submission
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={idx} className="flex gap-4">
                      ...
                      <p
                        className={`font-medium ${step.completed ? "text-slate-600 line-through" : "text-slate-900"}`}
                      >
                        {step.title}
                      </p>
                    </div>
          ...
          {activeTab === "Tasks" && (
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              ...
              <p className="text-slate-600 italic">
                No complex tasks currently assigned. Check back later.
              </p>
            </div>
          )}
          ...
          {activeTab === "Profile" && (
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              ...
              <p className="text-slate-600 italic">
                Profile management is currently handled by HR.
              </p>
            </div>
          )}
            ...
            <div className="space-y-4">
              {[
                ...
                },
                {
                  ...
                  message:
                    "New training materials have been added to your dashboard",
                  time: "1 day ago",
                  icon: "📚",
                },
